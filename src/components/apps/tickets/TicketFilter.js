...
const TicketFilter = () => {
  ...
  const pendingC = counter.filter((t) => t.Status === 'Pendente').length;
  const openC = counter.filter((t) => t.Status === 'Em aberto').length;
  const closeC = counter.filter((t) => t.Status === 'Finalizada').length;
  return (
    <Grid container spacing={3} textAlign="center">
      <Grid item xs={12} sm={6} lg={3}>
        ...
        >
          ...
          <Typography variant="h6">Total de O.S</Typography>
        </BoxStyled>
      </Grid>
      <Grid item xs={12} sm={6} lg={3}>
        <BoxStyled
        ...
        >
          ...
          <Typography variant="h6">O.S Pendentes</Typography>
        </BoxStyled>
      </Grid>
      <Grid item xs={12} sm={6} lg={3}>
        <BoxStyled
        ...
        >
          ...
          <Typography variant="h6">O.s Abertas</Typography>
        </BoxStyled>
      </Grid>
      <Grid item xs={12} sm={6} lg={3}>
        <BoxStyled
        ...
        >
          ...
          <Typography variant="h6">O.S Finalizadas</Typography>
        </BoxStyled>
      </Grid>
    </Grid>
  );
